...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.serieslabel.setGeometry(QRect(10, 60, 67, 17))
        ...
        self.note.setGeometry(QRect(10, 360, 321, 111))
        ...
        self.series.setGeometry(QRect(10, 80, 321, 25))
        ...
        self.deleteButton.setGeometry(QRect(20, 480, 89, 25))
        self.modifyButton = QPushButton(Dialog)
        self.modifyButton.setObjectName(u"modifyButton")
        self.modifyButton.setGeometry(QRect(130, 480, 89, 25))
        self.cancelButton = QPushButton(Dialog)
        self.cancelButton.setObjectName(u"cancelButton")
        self.cancelButton.setGeometry(QRect(240, 480, 89, 25))
